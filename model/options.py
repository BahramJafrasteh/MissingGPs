...
class options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', default='nn',
                            help='DSVI_Latent_Inverse | DSVI')


        parser.add_argument('--nolayers', type=int, default=0,
        ...
        parser.add_argument('--M2', type=int, default=10, help='number of inducing points missing')
        ...
        parser.add_argument('--kernel', type=str, default='matern',
                            help='matern|rbf|nsrbf')

        parser.add_argument('--no_iterations', type=int, default=1000, help='number of inducing points')

        parser.add_argument('--var_noise', type=float, default=1e-4, help='variance noise')

        parser.add_argument('--lrate', type=float, default=1e-2, help='learning rate')

        parser.add_argument('--likelihood_var', type=float, default=0.01, help='variance noise gaussian likelihood')

        parser.add_argument('--minibatch_size', type=int, default=100, help='mini-batch size')
        ...
        parser.add_argument('--fitting', action='store_true', help='fitting the model to the data')


        parser.add_argument('--missing', action='store_true', help='shared parameters in nueral network')

        parser.add_argument('--consider_miss', action='store_true', help='shared parameters in nueral network')
    ...
    def parse(self, write_conf=True):
        ...
        if opt.missing:
            ...
            add = 'non_missing'
        if write_conf:
            path_config = "results/{}/{}/s{}_{}_{}_{}/".format(opt.name.lower(), opt.dataset_name,
